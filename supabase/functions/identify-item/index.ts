...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt =
      ...
      "in a household inventory. Reply with ONLY the item name: 3 to 4 words, short and " +
      "recognisable. Include the object type (e.g. mug, book, bottle, charger) plus the one " +
      "most useful identifier — usually its colour or, if clearly legible, its brand or title. " +
      "Drop extra details like publisher, format, or material unless needed to tell it apart. " +
      "Do not invent details you cannot see. No explanation, no quotes, no trailing punctuation. " +
      "Examples: black leather wallet | Indiana coffee mug | " +
      "Charlotte's Web book | white usb-c charger";
